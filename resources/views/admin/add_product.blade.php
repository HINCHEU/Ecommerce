                ...
                <form class="tf-section-2 form-add-product" method="post" action="{{route('admin.create')}}"
                    ...
                    <div class="wg-box">
                        ...
                        <fieldset class="description">
                            ...
                            <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" rows="30"
                                      aria-required="true"
                            ...
                            <div class="upload-image mb-16">
                                ...
                                <div class="item up-load">
                                    <label class="uploadfile" for="myFile1">
                                        <span class="text-tiny" id="textDisplay1">Drop your images here or select <span class="tf-color">click to browse</span></span>
                                        <input type="file" id="myFile1" name="filename1" onchange="previewImage(event, 'imagePreview1', 'textDisplay1')">
                                        <img src="images/upload/upload-2.png" alt="" id="imagePreview1" style="display: none; width: 200px; height: auto;">
                                    </label>
                                </div>

                                <div class="item up-load">
                                    <label class="uploadfile" for="myFile2">
                                        <span class="text-tiny" id="textDisplay2">Drop your images here or select <span class="tf-color">click to browse</span></span>
                                        <input type="file" id="myFile2" name="filename2" onchange="previewImage(event, 'imagePreview2', 'textDisplay2')">
                                        <img src="images/upload/upload-2.png" alt="" id="imagePreview2" style="display: none; width: 200px; height: auto;">
                                    </label>
                                </div>

                                <div class="item up-load">
                                    <label class="uploadfile" for="myFile3">
                                        <span class="text-tiny" id="textDisplay3">Drop your images here or select <span class="tf-color">click to browse</span></span>
                                        <input type="file" id="myFile3" name="filename3" onchange="previewImage(event, 'imagePreview3', 'textDisplay3')">
                                        <img src="images/upload/upload-2.png" alt="" id="imagePreview3" style="display: none; width: 200px; height: auto;">
                                    </label>
                                </div>
